        ...
        <div className="min-h-screen bg-base-bg text-content-dark">
            ...
            <main className="max-w-4xl mx-auto px-4 md:px-8 py-8">
                ...
                <section className="mb-8 p-6 bg-base-bg rounded-xl border border-content-dark">
                    ...
                    <p className="text-content-dark leading-relaxed">
                        The motor is driven by a specialized motor driver that translates the microcontroller&apos;s 
                        PWM signals into the three-phase signals needed for BLDC operation.
                    </p>
                </section>
                ...
                <section className="mb-8">
                    ...
                    <img
                        ...
                        alt="Custom PCB Board"
                        className="w-full rounded-xl shadow-lg"
                    />
                    <p className="text-content-dark leading-relaxed mt-4">
                        The custom PCB integrates the ESP32 microcontroller, motor driver connections, sensor inputs, 
                ...
                <section className="mb-8 p-6 bg-base-bg rounded-xl border border-content-dark">
                    ...
                    <p className="text-content-dark leading-relaxed mb-4">
                        ...
                        mounted on a vibrating vehicle.
                    </p>
                    <p className="text-content-dark leading-relaxed">
                        The potentiometer uses a conductive plastic element for low noise and high precision over 
                        the stroke length of the sheave travel.
                    </p>
                </section>
                ...
                <section className="flex flex-wrap gap-4">
                    ...
                    <a
                        href="/projects/ecvt/ecvt electronics 24-25.docx.pdf"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center px-6 py-3 text-sm font-semibold text-accent border border-accent rounded-lg hover:bg-accent/10 transition duration-300"
                    >
                        <FileText className="w-4 h-4 mr-2" /> Full Design Document
                    </a>
                </section>
            </main>
